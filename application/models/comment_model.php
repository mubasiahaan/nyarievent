...
Class Comment_model extends MY_Model {
    ...
    public function __construct() {
        parent::__construct();
        $this->_table = 'comment';
        $this->_view = 'v_forum_comment';
    }

    function get_list_data($list = null, $limit = null, $offset = 0) {
        $where = "status = '1' and category_id IN ($list)";
        return $this->get_data(null, $where, $limit, $offset, 'insert_date DESC');
    }

    function get_galery($limit = null, $offset = 0) {
        return $this->get_data(null, array('status' => 1, 'category_id' => 3), $limit, $offset, 'insert_date DESC');
    }
