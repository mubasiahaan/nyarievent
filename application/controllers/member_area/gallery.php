...
class Gallery extends MY_Controller {
    ...
    function __construct() {
        ...
        parent::__construct();
        $this->is_user_login();
        $this->page_dir = 'member_area/gallery/';
        $this->data ['html_link'] = $this->get_config('app_member_area_link', TRUE);
        $this->data ['html_script'] = $this->get_config('app_member_area_script', TRUE);
        $this->layout_dir = 'member_area/layout/';
        $this->data['menu'] = 'gallery';
        $this->data['controler'] = 'gallery';
    ...
    function detail() {
        ...
        $this->data ['navigation']['member_area/gallery'] = $this->data['active_menu'];
    ...
    function edit() {
        ...
        $this->data ['navigation']['member_area/gallery'] = $this->data['active_menu'];
        $this->data ['navigation']['member_area/gallery/detail/' . $this->data['rec_data']->category] = ($this->data['cat_id'] == 'all') ? 'All' : $this->category->get_data(null, array('id' => $this->data['rec_data']->category), null, null, null, null, 'row')->name;
        ...
        if ($this->input->post('submit')) {
            ...
            if ($this->form_validation->run()) {
                ...
                if ($this->m_gallery->edit_data($data, array('id' => $this->data['cat_id']))) {
                    ...
                    redirect(site_url('member_area/gallery'));
                } else {
