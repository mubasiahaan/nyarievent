...
class Share_moment extends MY_Controller {
    ...
    function __construct() {
        ...
        $this->page_dir = 'member_area/share_moment/';
        $this->data['active_menu'] = 'Share Moment';
        $this->data['controler'] = 'share_moment';
    ...
    function index() {
        ...
        $this->data ['list_data'] = $this->story->get_data(null, $where, null, null, null, 'id desc');
    ...
    function add() {
        ...
        $this->data ['navigation']['member_area/story/index/' . $this->data['cat_id']] = $this->data['active_menu'];
    ...
    function delete() {
        ...
        redirect(site_url('member_area/share_moment/index/' . $page));
    }
