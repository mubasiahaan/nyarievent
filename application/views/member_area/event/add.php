    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body dafter">
           <div class="panel-body">
                ...
                <form class="form-horizontal" action="<?php echo site_url('member_area/event/add/'); ?>" method="post" role="form" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <textarea name="txt_location" rows="4" id="txt_location" class="txt_preface form-control" placeholder="Input your location"><?php echo set_value('txt_location'); ?></textarea>
                        </div>
                    </div>
                    <div class="form-group">
