    ...
    <div class="col-lg-10">
        <div class="panel panel-blue">
            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal" action="<?php echo site_url('member_area/share_moment/update/' . $rec_data->id); ?>" method="post" role="form" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-5">
                            <input type="text" class="form-control" id="image" name="image" value="<?php echo set_value('image', $rec_data->image); ?>"/>
                        </div>
                        <div class="col-lg-2">
                           <a href="#myModal" role="button" class="btn btn-default" data-toggle="modal">Select Image</a>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-2 control-label" for="focus">Image</label>
