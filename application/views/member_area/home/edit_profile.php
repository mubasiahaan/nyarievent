<div class="col-md-10 ">
    <div class="contact mar-top30 mar-btm30">
        ...
        ?>
        <form class="form-horizontal" action="<?php echo site_url('member_area/home/edit_profile'); ?>" method="post" role="form">
            ...
            <div class="form-group">
                <div class="col-md-offset-2 col-md-10">
                    ...
                    <a href="<?php echo site_url('member_area/home/reset_pass/'); ?>"
        ...
        ?>
        <form class="form-horizontal" action="<?php echo site_url('member_area/home/edit_profile'); ?>" method="post" enctype="multipart/form-data" role="form">
            <div class="form-group">
