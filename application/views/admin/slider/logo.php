    ...
    <div class="col-lg-12">
        <div class="panel panel-blue">
            ...
            <div class="panel-body">
                ...
                ?>
                <form class="form-horizontal" action="<?php echo site_url('admin/slider/logo'); ?>" method="post" enctype="multipart/form-data" role="form">
                    
                   
                    <div class="form-group">
                        <label class="col-lg-1 control-label" for="focus">Image (Resolusi 162*82 .png)</label>
                        <div class="col-lg-11">
                    ...
                    <div class="form-group">
                        <label class="col-lg-1 control-label" for="focus">Logo</label>
                        <div class="col-lg-11">
                           <img src="<?php echo base_url(); ?>/assets/img/logo.png" class="img-responsive hidden-xs" alt="" />
                        </div>
                    </div>
